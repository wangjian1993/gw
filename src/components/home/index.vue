...
export default {
  ...
  data() {
    return {
      bannerList: [
        "http://resource.alilo.com.cn/static/img/banner-1.bf09041.jpg",
        require('../../assets/img/home/banner-2.png'),
       "http://resource.alilo.com.cn/static/img/banner-3.536a6ad.png",
        "http://resource.alilo.com.cn/static/img/banner-4.c918eac.png",
